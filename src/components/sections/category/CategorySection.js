...
const CategorySection = ({ name, data, onDataChange, onAddCategory, selectedCategories }) => {
    ...
    return (
        <div style={{ display: 'flex', alignItems: 'stretch', borderTop: '1px solid #ddd', borderRadius: '4px' }}>
            <h4 style={{
                marginRight: '20px',
                marginBottom: '0',
                width: '100px',
            ...
            <div>
                <ul style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'flex-start', margin: 0, padding: '8px' }}>
                    {data?.map((d) => (
                        <li key={d.categoryId} 
